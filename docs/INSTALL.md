...
- To force the MCP tools regardless of project signals, set `ZENVIBE_LANG=fr` or `ZENVIBE_LANG=en` in the environment that starts the MCP server. Any other value is ignored.
